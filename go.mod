...
replace (
	github.com/cosmos/cosmos-sdk => github.com/graphprotocol/cosmos-sdk v0.45.3-fh
	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1
	github.com/tendermint/tendermint => github.com/graphprotocol/tendermint v0.34.19-fh.2
